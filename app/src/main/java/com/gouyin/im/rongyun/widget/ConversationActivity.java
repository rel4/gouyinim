package com.gouyin.im.rongyun.widget;
 ...
 */
public class ConversationActivity extends BaseApiActivity implements  Handler.Callback {
    ...
    //    private AbstractHttpRequest<ContactsContract.Groups> mGetMyGroupsRequest;

package com.gouyin.im.update.model;
...
import com.gouyin.im.update.down.DownloadProgressHandler;
...
public class UpdateManagerModelImpl implements UpdateManagerModel {
    ...
    public void downFile(String url, String savePath, onDownFileleListener listener) {
        url = "http://msoftdl.360.cn/360antivirus/360AntiVirus_offical_beta.apk";

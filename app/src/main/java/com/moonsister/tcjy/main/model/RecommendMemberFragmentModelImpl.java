...
public class RecommendMemberFragmentModelImpl implements RecommendMemberFragmentModel {
    ...
    @Override
    public void loadData(onLoadDateSingleListener<RecommendMemberFragmentBean> listener) {
        int pagesize = 20;
    ...
    public void getRecommend(String uid, onLoadDateSingleListener<DefaultDataBean> listener) {
        ServerApi.getAppAPI().getRecommend(uid, UserInfoManager.getInstance().getAuthcode(), AppConstant.CHANNEL_ID)

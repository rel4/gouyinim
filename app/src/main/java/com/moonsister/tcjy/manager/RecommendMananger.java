...
public class RecommendMananger {
    ...
    public void start() {
        ...
        model.loadData(new BaseIModel.onLoadDateSingleListener<RecommendMemberFragmentBean>() {
            @Override
    ...
    public void recommendMemberStatus(boolean islike, String uid) {
        RecommendMemberFragmentModelImpl model = new RecommendMemberFragmentModelImpl();
        model.getRecommend(uid, new BaseIModel.onLoadDateSingleListener<DefaultDataBean>() {
            @Override
